...
if __name__ == '__main__':
    ...
    l = link.Link(address=1,startpoint=n1,endpoint=n2,bandwidth=1000000.0,propagation=1.0)
    n1.add_link(l)
    n1.add_forwarding_entry(address=2,link=l)

    # create link from n2 to n1
    l = link.Link(address=2,startpoint=n2,endpoint=n1,bandwidth=1000000.0,propagation=1.0)
    n2.add_link(l)
